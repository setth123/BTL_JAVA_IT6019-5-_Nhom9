        ...
        btnRegister.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                if (userName.isEmpty()) {
                    ...
                    Account a = new Account(name, address, phoneNumber, userName, password);
                    java.util.List<Account> accounts = ReadData.readAccount("user-account.txt");
                    accounts.add(a);
                    WriteData.writeAccount(accounts, "user-account.txt");
